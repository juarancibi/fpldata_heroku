...
current_gw = events_df.name[events_df['is_current'] == True].tolist()[0]
st.write('The current gameweek is ' + str(current_gw))                                    ## MUESTRA EN LA PÁGINA LA FECHA ACTUAL DE LA PREMIER                                   

...
testGraph2 = pd.read_csv('https://raw.githubusercontent.com/juarancibi/fpldata_heroku/main/testGraph.csv?token=AQBPKDGQMGXKI473OT222MLAQIQAK').set_index('player name')
